...
label_folder = "/NEW_EDS/JJ_Group/zhuzr/DPS_copy/results/diffjpeg/input_face"
predi_folder = "/NEW_EDS/JJ_Group/zhuzr/DPS_copy/results/diffjpeg/label_face"
...
kid_computer = KernelInceptionDistance(subsets =100, subset_size=300, normalize=True).cuda()
